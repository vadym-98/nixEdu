...
func (h *RegexMuxer) Post(pattern string, f func(w http.ResponseWriter, r *http.Request)) {
	h.addEntry(http.MethodPost, pattern, f)
}

func (h *RegexMuxer) Put(pattern string, f func(w http.ResponseWriter, r *http.Request)) {
	h.addEntry(http.MethodPut, pattern, f)
}

func (h *RegexMuxer) Delete(pattern string, f func(w http.ResponseWriter, r *http.Request)) {
	h.addEntry(http.MethodDelete, pattern, f)
}
